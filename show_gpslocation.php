...
<div class="contact_container">
 <?php
  ...
  if (loggedin()) {
    $result = mysql_query("SELECT * FROM gpslocation");
    ...
    <table border="1">
        ...
        <tbody>
          ...
          <td>{$row['longitude']}</td>
           <td>
      <form  action='mapdata.php' method='POST'>
       <input id='submit' type='submit' value='Map' />
        <input id='data1' type='hidden' name='sdf' value='jpt' />
      </form>
      </td>
        </tr>";
            }
